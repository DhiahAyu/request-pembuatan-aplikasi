...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.addReqBtn', function () {
            ...
            // Tambahkan event listener untuk menampilkan preview gambar saat file dipilih
            $(`#mockup-${modulId}-${counterReq}`).change(function () {
                readURL(this, `#preview-${modulId}-${counterReq}`);
            });
        });
