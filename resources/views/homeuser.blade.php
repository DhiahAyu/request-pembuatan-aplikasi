...
<div class="card-header border-0">
    <div class="justify-content-between" style="text-justify:center;">
        <h1 class="text-center"><strong>APPLICATION REQUEST</strong></h1>
    </div>
</div>
<div class="card-body">
                ...
                <tr style="text-align: center; vertical-align: middle;">
                    ...
                    @if ($row->status=='Not Yet Submitted')
                        <td style="vertical-align: middle;">
                            <h5><span class="badge badge-pill badge-info">Draft</span></h5>
                        </td>
                    @endif
                    ...
                    @if ($row->status=='Approved')
                        <td style="vertical-align: middle;">
                            <h5><span class="badge badge-pill badge-success">{{$row->status}}</span>
                            </h5></td>
                    @endif
                    @if ($row->status=='Rejected')
                        <td style="vertical-align: middle;">
                            <h5><span class="badge badge-pill badge-danger">{{$row->status}}</span></h5>
                        </td>
                    @endif
                    <td style="vertical-align: middle;">
                        @if ($row->status=='Not Yet Submitted')
...
<!--content-->
>>>>>>> 89bf05f14f442730bc28f6d73c3f9c97dcc898c6
