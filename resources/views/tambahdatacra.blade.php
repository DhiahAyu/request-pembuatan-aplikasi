                                        ...
                                        <tr class="p-2">
                                            ...
                                            <td width="76%">	
                                                <div class="container mb-3">
                                                    <button type="button" class="btn btn-success" id="addmajor">
                                                        <i class="fas fa-solid fa-plus" style="color: #ffffff;"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-success" id="removemajor">
                                ...
                                <table class="table table-bordered" style="margin-top: 1em;">
                                    <tbody>
                                        <tr class="p-2">
                                            ...
                                            <td width="76%">	
                                                <div class="container mb-3">
                                                    <button type="button" class="btn btn-success" id="addminor">
                                                        <i class="fas fa-solid fa-plus" style="color: #ffffff;"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-success" id="removeminor">
                                                        <i class="fas fa-solid fa-minus"></i>
                                                    </button>
                                                </div>
