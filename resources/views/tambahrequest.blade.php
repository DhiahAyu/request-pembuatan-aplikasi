            ...
            <div class="col-12">
                <div class="card">
                  <div style="margin: 10px">
                    <h3 class="text-center p-2" style="color: rgba(0, 0, 0, 0.650)"> <strong>FORM REQUEST</strong></h3>
                    <div class="container">
                      <div class="row justify-content-center">
                      <form action="/insertdata" method="POST" enctype="multipart/form-data">
                        @csrf
                        <h5 class="mb-3 text-center">FORMULIR PERMINTAAN PEMBANGUNAN APLIKASI TI</h4>
