...
<html lang="en">
    ...
    <body>
        <div class="row">
            <div class="col">
                <img src="{{asset('template/dist/img/bglogin4.jpg')}}" style="absolute; width: 650px; height:590px;">
                <div style="position: absolute; top: 0; left: 0; width: 650px; height: 590px; background: linear-gradient(rgba(83, 80, 248, 0.25), rgba(83, 80, 248, 0.25));"></div>
            </div>
